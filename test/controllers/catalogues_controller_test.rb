...
class CataloguesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create catalogue" do
    assert_difference("Catalogue.count") do
      post catalogues_url, params: { catalogue: { accessories: @catalogue.accessories, age: @catalogue.age, caliber: @catalogue.caliber, capacity: @catalogue.capacity, comments: @catalogue.comments, manufacturer: @catalogue.manufacturer, name: @catalogue.name } }
    end
  ...
  test "should update catalogue" do
    patch catalogue_url(@catalogue), params: { catalogue: { accessories: @catalogue.accessories, age: @catalogue.age, caliber: @catalogue.caliber, capacity: @catalogue.capacity, comments: @catalogue.comments, manufacturer: @catalogue.manufacturer, name: @catalogue.name } }
